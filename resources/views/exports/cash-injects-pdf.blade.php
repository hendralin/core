...
<head>
    <meta charset="utf-8">
    <title>Cash Inject Records Export</title>
    <style>
        body {
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Cost Date</th>
                <th>Description</th>
                <th class="text-right">Total Inject</th>
                <th>Created By</th>
            </tr>
        </thead>
        <tbody>
            ...
            <!-- Total Row -->
            <tr class="total-row">
                <td colspan="3" class="text-right"><strong>TOTAL INJECT KAS:</strong></td>
