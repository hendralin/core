<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('User Audit Trail') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Track all activities performed on user accounts') }}</flux:subheading>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <!-- User Filter -->
            <div>
                <label for="user-filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    User
                </label>
                <flux:select wire:model.live="selectedUser">
                            ...
                            <div class="flex-shrink-0">
                                <div class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/20 flex items-center justify-center">
                                    @switch($activity->description)
                                        @case('created a new user account')
                                            <flux:icon.plus class="w-5 h-5 text-green-600 dark:text-green-400" />
                                            @break
                                        @case('updated user profile information')
                                ...
                                @if($activity->properties && isset($activity->properties['attributes']))
                                    <div class="mt-3">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                                            @if($activity->description === 'updated user profile information' && isset($activity->properties['old']))
