    ...
    <div class="border-t border-gray-200 dark:border-zinc-800 px-3 py-2">
        <form wire:submit.prevent="ask" class="flex items-end gap-2"
            ...
            <textarea
                ...
                rows="2"
                class="flex-1 resize-none pl-2 pr-2 pt-0.5 text-sm rounded-md border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:focus:ring-green-500 dark:focus:border-green-500"
                placeholder="Contoh: screening saham bullish harian dengan volume besar di sektor perbankan..."></textarea>
