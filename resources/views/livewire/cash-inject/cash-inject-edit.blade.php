<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Inject Kas') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Perbarui informasi inject kas perusahaan') }}</flux:subheading>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div class="xl:col-span-3">
            ...
            <form wire:submit="submit" id="cash-inject-edit-form" class="mt-6 space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            <flux:select wire:model="cost_type" label="Tipe Kas" class="w-full">
                                <flux:select.option value="">Pilih Tipe Kas</flux:select.option>
                                @if(auth()->id() == 2)
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="shrink-0">
                            ...
                            @elseif($existing_document)
                                ...
                                <div class="relative">
                                    @php
                                        $documentPath = storage_path('app/public/photos/costs/' . $existing_document);
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-zinc-700">
                    ...
                    <flux:button type="submit" variant="primary" icon="pencil">
                        <span wire:loading.remove wire:target="submit">Perbarui Inject Kas</span>
