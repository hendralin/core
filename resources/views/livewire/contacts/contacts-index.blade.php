<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Manage all your contacts') }}</flux:subheading>
            ...
            <div class="p-4 border-b border-gray-200 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-800/50">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="flex-1 max-w-md">
                        <div class="relative">
                            <flux:input wire:model.live.debounce.300ms="search" icon="magnifying-glass" placeholder="Search contacts..." clearable />
                        </div>
                    </div>
                                ...
                                <tr class="odd:bg-white odd:dark:bg-zinc-900 even:bg-gray-50 even:dark:bg-zinc-800 border-b dark:border-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-700/50" wire:loading.class="opacity-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-start space-x-2">
                                            @can('contact.view')
                                                <flux:button variant="ghost" size="xs" square href="{{ route('contacts.show', $contact->id) }}" wire:navigate tooltip="Show">
    ...
    <flux:modal name="sync-contacts-modal" class="min-w-96">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Sync Contacts</flux:heading>
                <flux:text class="mt-2">Select a session to synchronize contacts from WhatsApp.</flux:text>
            </div>

            <form wire:submit="syncContacts" class="space-y-6">
                <flux:select wire:model="selectedSessionId" label="Session">
                    <flux:select.option value="">Select a session to sync contacts from</flux:select.option>
