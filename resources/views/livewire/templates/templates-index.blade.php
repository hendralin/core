                            ...
                            @foreach($templates as $index => $template)
                                <tr class="hover:bg-gray-50 dark:hover:bg-zinc-900" wire:loading.class="opacity-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ Str::limit($template->body, 50) }}</div>
                                    </td>
            ...
            @if($templateToPreview)
                <div class="space-y-4">
                    ...
                    <div class="bg-green-50 dark:bg-green-900/10 rounded-lg p-4 border border-green-200 dark:border-green-800">
                        ...
                        <!-- Additional info -->
                        <div class="text-xs text-gray-600 dark:text-gray-400 mt-3 space-y-1">
    ...
    <flux:modal name="delete-template" class="min-w-88">
        <div class="space-y-6">
            ...
            <div class="flex gap-2">
                ...
                <flux:button wire:click="delete" variant="danger">Delete Template</flux:button>
            </div>
        </div>
    </flux:modal>
