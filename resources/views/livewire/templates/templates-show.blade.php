                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-3 mb-6">
                        <div>
                            ...
                            <flux:text class="text-sm text-gray-500">by {{ $template->createdBy->name ?? 'Unknown' }}</flux:text>
                        </div>
                        <div>
                            ...
                            <flux:text class="text-sm text-gray-500">by {{ $template->updatedBy->name ?? 'Unknown' }}</flux:text>
                        </div>
                        <div>
                            <flux:heading size="sm" class="text-gray-600 dark:text-gray-400">Usage Count</flux:heading>
                            <flux:text class="mt-1">{{ $template->usage_count }}</flux:text>
                        </div>
                        <div>
                            <flux:heading size="sm" class="text-gray-600 dark:text-gray-400">Last Used</flux:heading>
                    ...
                    <div class="sticky top-6">
                        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 overflow-hidden">
                            <div class="p-4 border-b border-gray-200 dark:border-zinc-700 bg-gray-50 dark:bg-zinc-800/50">
                                ...
                                <flux:text class="text-sm text-gray-600 dark:text-gray-400 mt-1">How the message will appear</flux:text>
                            </div>
