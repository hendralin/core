<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Audit Trail Pembayaran PKB') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Pantau semua aktivitas yang dilakukan pada pembayaran PKB') }}</flux:subheading>
        <flux:separator variant="subtle" />
    </div>

    <flux:button variant="primary" size="sm" href="{{ route('vehicle-tax-payments.index') }}" wire:navigate icon="arrow-uturn-left" tooltip="Kembali ke Pembayaran PKB" class="mb-4">Back</flux:button>
    ...
    <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6 mb-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <!-- Record Filter -->
            <flux:select label="Pembayaran PKB" wire:model.live="selectedCost">
                                ...
                                @if($activity->properties && isset($activity->properties['attributes']))
                                    <div class="mt-3">
                                        ...
                                        <div class="bg-gray-50 dark:bg-zinc-700 rounded-lg p-3">
                                            @if($activity->description === 'updated pembayaran pkb record' && isset($activity->properties['old']))
        ...
        @else
            ...
            <div class="p-12 text-center">
                ...
                <flux:text class="mt-2 text-gray-600 dark:text-zinc-400">
                    ...
                    @else
                        No pembayaran PKB activities have been recorded yet.
                    @endif
                </flux:text>
            </div>
        @endif
