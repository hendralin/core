<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Tambah Pembayaran PKB') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Tambahkan informasi pembayaran Pajak Kendaraan Bermotor (PKB)') }}</flux:subheading>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div class="xl:col-span-3">
            ...
            <form wire:submit="submit" id="vehicle-tax-payment-form" class="mt-6 space-y-6" enctype="multipart/form-data">
