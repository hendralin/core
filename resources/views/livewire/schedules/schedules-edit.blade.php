<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Schedule') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for edit schedule') }}</flux:subheading>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
                        <flux:heading size="lg" class="mb-6">Edit Schedule</flux:heading>
                        ...
                        <form wire:submit="submit" class="space-y-6">
                            ...
                            <div class="flex gap-3 pt-4">
                                <flux:button type="submit" variant="primary" class="cursor-pointer">Update Schedule</flux:button>
                                <flux:button variant="ghost" href="{{ route('schedules.show', $schedule->id) }}" wire:navigate>Cancel</flux:button>
                            </div>
                        </form>
                    </div>
                </div>
