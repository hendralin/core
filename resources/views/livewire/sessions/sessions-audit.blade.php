        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <flux:text class="text-xs text-gray-600 dark:text-gray-400">Total Sessions</flux:text>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <flux:text class="text-xs text-gray-600 dark:text-gray-400">Working</flux:text>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <flux:text class="text-xs text-gray-600 dark:text-gray-400">Stopped</flux:text>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <flux:text class="text-xs text-gray-600 dark:text-gray-400">Scan QR</flux:text>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <flux:text class="text-xs text-gray-600 dark:text-gray-400">Online</flux:text>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-zinc-900">
                                    ...
                                    <div class="shrink-0 h-10 w-10">
                                        ...
                                        @else
                                            <div class="h-10 w-10 rounded-full bg-gray-300 dark:bg-zinc-600 flex items-center justify-center">
                                                <flux:icon.user class="h-6 w-6 text-gray-600 dark:text-gray-400" />
                                            </div>
                                        @endif
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($activity->subject)
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ $activity->subject->session_id }}</div>
                                @else
                                    <span class="text-gray-400">Deleted Session</span>
                                @endif
                            </td>
                            <td class="px-6 py-4">
