        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                @if(session()->has('company_draft'))
                    <flux:button wire:click="restoreDraft" size="sm" icon="arrow-path">
                        Restore Draft
                    </flux:button>
                @endif
            </div>
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="shrink-0">
                        ...
                        @elseif($company->logo)
                            ...
                            <div class="relative">
                                <img src="{{ \Illuminate\Support\Facades\Storage::disk('logos')->url($company->logo) }}" alt="Current Logo" class="w-24 h-24 object-contain rounded-lg border-2 border-gray-200 dark:border-zinc-700">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6 lg:col-span-2">
                    ...
                    @if(!empty($socialMedia))
                        <div class="mb-6">
                            <h4 class="text-sm font-medium text-gray-700 dark:text-zinc-300 mb-3">Current Links:</h4>
                            <div class="space-y-2">
                                @foreach($socialMedia as $index => $social)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-700 rounded-lg">
                                        <div class="flex items-center space-x-3">
                                            <span class="font-medium text-gray-900 dark:text-zinc-100 capitalize">{{ $social['platform'] }}</span>
                    ...
                    <div class="border-t border-gray-200 dark:border-zinc-600 pt-4">
                        <h4 class="text-sm font-medium text-gray-700 dark:text-zinc-300 mb-3">Add New Link:</h4>
                    ...
                    @if($showLicenseSection)
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">License Type</label>
                                    <select wire:model="license_type" class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-700 dark:text-zinc-300">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">License Status</label>
                                    <select wire:model="license_status" class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-700 dark:text-zinc-300">
                            ...
                            <div>
                                ...
                                @if(!empty($features_enabled))
                                    <div class="mb-4">
                                        <h5 class="text-sm font-medium text-gray-600 dark:text-zinc-400 mb-2">Current Features:</h5>
