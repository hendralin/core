    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="text-center p-4 bg-cyan-50 dark:bg-cyan-900/20 rounded-lg border border-cyan-200 dark:border-cyan-800">
                        <div class="text-2xl font-bold text-cyan-600 dark:text-cyan-400">{{ \App\Models\Contact::forUser(auth()->id())->count() }}</div>
                    ...
                    <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                        <div class="text-2xl font-bold text-green-600 dark:text-green-400">{{ \App\Models\Contact::forUser(auth()->id())->whereNotNull('verified_name')->count() }}</div>
                    ...
                    <div class="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ \App\Models\Contact::forUser(auth()->id())->whereNotNull('profile_picture_url')->count() }}</div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                        <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ \App\Models\Schedule::where('created_by', auth()->id())->where('frequency', 'daily')->count() }}</div>
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                        <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ \App\Models\Template::where('created_by', auth()->id())->count() }}</div>
                        <div class="text-sm text-purple-700 dark:text-purple-300">Total Templates</div>
                    </div>
                    <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                        <div class="text-2xl font-bold text-green-600 dark:text-green-400">{{ \App\Models\Template::where('created_by', auth()->id())->where('is_active', true)->count() }}</div>
                        <div class="text-sm text-green-700 dark:text-green-300">Active Templates</div>
                    </div>
                    <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ \App\Models\Template::where('created_by', auth()->id())->sum('usage_count') }}</div>
                        <div class="text-sm text-blue-700 dark:text-blue-300">Total Usage</div>
                    </div>
                    <div class="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                        <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ \App\Models\Template::where('created_by', auth()->id())->where('last_used_at', '>=', now()->startOfWeek())->count() }}</div>
