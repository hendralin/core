<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Biaya Showroom') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Perbarui informasi biaya showroom') }}</flux:subheading>
