                        ...
                        <div class="shrink-0">
                            ...
                            @elseif($existing_document)
                                ...
                                <div class="relative">
                                    ...
                                    @endphp
                                    @if($isImage)
                                        <img src="{{ asset('storage/photos/costs/' . $existing_document) }}" alt="Existing Document Preview" class="w-24 h-24 object-contain rounded-lg border-2 border-green-200 dark:border-green-700">
                                    @else
