<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Pembayaran Pinjaman') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Perbarui data pembayaran pinjaman') }}</flux:subheading>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
        <div class="xl:col-span-3">
            ...
            <form wire:submit="submit" id="employee-loan-payment-edit-form" class="mt-6 space-y-6">
                <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6 mb-6">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <flux:heading size="md">Informasi Pembayaran</flux:heading>
                            <flux:subheading size="sm">Karyawan: {{ $employeeLoanPayment->employee?->name ?? '-' }}</flux:subheading>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-slate-500 dark:text-zinc-400 mt-1">Status sumber dana tidak dapat diubah setelah penerimaan pembayaran pinjaman dibuat.</p>
                        </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-zinc-700">
                    <flux:button variant="ghost" href="{{ route('employee-loan-payments.show', $employeeLoanPayment) }}" wire:navigate>
