<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Form for create new employee') }}</flux:subheading>
            ...
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <flux:input wire:model="name" label="Employee Name" placeholder="Employee name..." />
                    </div>
                ...
                <div class="flex justify-end">
                    <flux:button type="submit" variant="primary" class="cursor-pointer">Create Employee</flux:button>
                </div>
            </form>
        </div>
    </div>
