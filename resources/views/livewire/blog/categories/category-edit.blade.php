<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Edit Blog Category') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Update category information') }}</flux:subheading>
    ...
    <form wire:submit="submit" class="space-y-6">
        ...
        <div class="flex justify-end gap-3 pt-6 border-t border-gray-200 dark:border-zinc-700">
            ...
            <flux:button type="submit" variant="primary" wire:loading.attr="disabled">
                <span wire:loading.remove>{{ __('Update Category') }}</span>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-zinc-700">
        <flux:heading size="md" class="mb-4">{{ __('Category Statistics') }}</flux:heading>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-gray-900 dark:text-zinc-100">{{ $category->posts_count }}</div>
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-sm font-medium text-gray-900 dark:text-zinc-100">{{ $category->created_at->format('M j, Y') }}</div>
            ...
            <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-sm font-medium text-gray-900 dark:text-zinc-100">{{ $category->updated_at->format('M j, Y') }}</div>
