<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Salary Component') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Form for create new salary component') }}</flux:subheading>
