...
class VehicleEdit extends Component
{
    ...
    protected $rules = [
        ...
        'file_stnk' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
        'warehouse_id' => 'required|exists:warehouses,id',
        'bpkb_number' => 'required|string|max:255',
        'bpkb_file' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:10240',
    ...
    protected $messages = [
        ...
        'vehicle_registration_date.date' => 'Tanggal Registrasi harus berupa tanggal yang valid.',
        'vehicle_registration_expiry_date.required' => 'Tanggal Kadaluarsa wajib diisi.',
        'vehicle_registration_expiry_date.date' => 'Tanggal Kadaluarsa harus berupa tanggal yang valid.',
        ...
        'selling_price.required_if' => 'Harga Penjualan wajib diisi ketika status Terjual.',
        'selling_price.numeric' => 'Harga Penjualan harus berupa angka.',
        'selling_price.min' => 'Harga Penjualan harus lebih dari 0.',
        'selling_price.max' => 'Harga Penjualan harus kurang dari 99999999999999.99.',
        ...
        'display_price.numeric' => 'Harga Jual harus berupa angka.',
        'display_price.min' => 'Harga Jual harus lebih dari 0.',
        'display_price.max' => 'Harga Jual harus kurang dari 99999999999999.99.',
        'selling_date.required_if' => 'Tanggal Penjualan wajib diisi ketika status Terjual.',
        ...
        'fuel_type.in' => 'Jenis Bahan Bakar harus Bensin atau Solar.',
        'tempImages.*.image' => 'File harus berupa gambar.',
        'tempImages.*.mimes' => 'Format gambar harus JPEG, JPG, PNG, GIF, atau WebP.',
        'tempImages.*.max' => 'Ukuran gambar tidak boleh lebih dari 5MB.',
        'tempImages.array' => 'Format upload gambar tidak valid.',
        'tempImages.max' => 'Maksimal 20 gambar yang dapat diupload.',
    ];
